        ...
        <div className={styles.content}>
          <div className={joinClassNames(styles.block, styles.pb125, styles.heroBackground, styles.hFull)}>
            ...
            <div className={joinClassNames(styles.container, styles.flexCol, styles.gap24, styles.mt90)}>
              <div className={joinClassNames(styles.caption, styles.textGreen)}>Lead the next wave of Telegram games
              </div>
              <Button
                text="Apply"
                href="https://airtable.com/appXnUdjNS7Fzxpq7/pagWSQDZwdqEVDv01/form"
          ...
          <div className={joinClassNames(styles.block, styles.pixelBackground, styles.mt110)}>
            ...
            <div
              className={joinClassNames(styles.container, styles.blueBox1, styles.mt240)}
              id="tools"
            >
          ...
          <div
            className={joinClassNames(styles.container, styles.block, styles.mt110)}
            id="partners"
          >
